...
//This is my programing 6 homework.Modifiyied
{
    [SerializeField]
    GameObject player;
    ...
    void Shot(Vector3 direction)
    {
        ...
        GameObject Lazer = Instantiate(lazer);
        Lazer.transform.position = transform.position + direction * 1.0f;
        Lazer.GetComponent<Rigidbody2D>().linearVelocity = direction * BulletSpeed;
